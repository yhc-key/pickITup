    ...
    <div>
      ...
      >
        <div>
          <div className="flex flex-col my-6">
            <div className="flex items-center justify-center">
              <label className="w-32 ">기존 비밀번호</label>
              <input
                type="password"
                value={lastPassword}
                onChange={(e) => {
          ...
          <div className="flex items-center justify-center">
            <label className="w-32">새 비밀번호</label>
            <input
              type="password"
              value={password}
              onChange={(e) => {
          ...
          <div className="text-xs pl-[8.5rem] text-f5red-300">
        ...
        <div className="flex flex-col">
          <div className="items-center justify-center h-10 my-1 ">
            <label htmlFor="password" className="w-32 mr-9">
              비밀번호 확인
            </label>
            <input
              type="password"
