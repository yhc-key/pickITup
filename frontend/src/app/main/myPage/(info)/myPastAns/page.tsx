                    ...
                    >
                      {isPastAnsHovered === index ? (
                        <div className="relative">
                          <div className="absolute right-0 top-2 px-5 py-4 w-[30rem] bg-f5black-400 text-white rounded-md text-sm">
                            <div className="absolute w-4 h-4 right-16 -top-1 origin-center rotate-45 border-t-[1rem]  border-t-f5black-400 "></div>
                            {interview.answer}
                          </div>
                        </div>
                      ) : null}
                  ...
                  <td className="text-center">
                    ...
                    >
                      {isExAnsHovered === index ? (
                        <div className="relative">
                          <div className="absolute right-0 top-2 px-5 py-4 w-[30rem] bg-f5black-400 text-white rounded-lg text-sm">
                            <div className="absolute w-4 h-4 right-16 -top-1 origin-center rotate-45 border-t-[1rem]  border-t-f5black-400"></div>
                            {interview.example}
                          </div>
                        </div>
