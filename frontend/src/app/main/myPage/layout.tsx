...
export default function MyPageLayout({
  ...
  const setKeywords: (newKeywords: string[])=> void = useAuthStore((state: AuthState) => state.setKeywords);
  const setProfile: (newProfile: number)=> void = useAuthStore((state: AuthState) => state.setProfile);
  ...
  return (
    <div className="flex mx-32 my-5">
      <div className="min-w-[330px] max-w-[330px]">
        ...
        <div className="p-3 mt-4 text-sm border rounded-lg border-f5gray-400">
          ...
          <div className="flex flex-row items-center gap-3 mt-2">
            ...
            <a href={blog} className="ml-0.5">{blog}</a>
          </div>
          <div className="flex flex-row items-center gap-3 mt-2">
      ...
      <TechSelectMyPage open={isTechSelectOpen} onclose={() => setIsTechSelectOpen(false)} />
