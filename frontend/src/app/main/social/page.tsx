...
function Social(){
    ...
    const requsetNaverLogin = () => {
        window.location.href = 'https://spring.pickitup.online/oauth2/authorization/naver';//url 집어넣기
    }
    const requsetGoogleLogin = () => {
        window.location.href = 'https://spring.pickitup.online/oauth2/authorization/google';//url 집어넣기
    }
    ...
    return (
        <div className="flex flex-col items-center w-full h-[600px]">
            ...
            <div className="w-[40vw] h-[50vh] grid place-items-center">
                ...
                <button onClick={requsetGoogleLogin} className="w-[25vw] h-[5vh] py-5 my-4 flex items-center justify-start rounded-[10px] border border-f5gray-400 whitespace-pre font-bold">
                ...
                <Link href="/main/login" className="w-[25vw] h-[5vh] py-5 my-4 flex items-center justify-start rounded-[10px] border border-f5gray-400 whitespace-pre font-bold">
