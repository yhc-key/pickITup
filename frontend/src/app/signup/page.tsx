        ...
        <div className="h-[30vh] w-[48vw] h-[62vh] rounded-[10px] border border-f5gray-400">
          ...
          <div >
            <div className='flex w-full h-[6vh] justify-center items-center mt-4'>
              ...
              <button onClick={(e)=>{checkid(),e.preventDefault()}} className='w-[7vw] h-[4vh] flex items-center justify-center rounded-md bg-f5green-300 text-xs text-white font-bold'>중복확인</button>
            </div>
            ...
            <div className='flex w-full h-[6vh] justify-center items-center'>
              ...
              <input type="password" value={samepass} onChange={(e)=>(setSamepass(e.target.value))}
              className="w-[24vw] h-[4vh] rounded-md  border border-f5gray-400
              bg-gray-200 appearance-none border-2 border-gray-200 
              text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-f5green-300 
              "/>
            ...
            <div className='flex w-full h-[1vh] justify-center items-center mb-2'>
              <div className="w-[10vw]"></div>
              <div className='w-[24vw] text-xs text-[#C55A5A]'>{issame?"":"위의 비밀번호와 동일하게 입력해주세요"}</div>
            </div>
            ...
            <div className='flex w-full h-[6vh] justify-center items-center'>
              ...
              placeholder="example@naver.com" className="w-[16vw] h-[4vh] rounded-md  border border-f5gray-400
              bg-gray-200 appearance-none border-2 border-gray-200
              text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-f5green-300
              "/>
              <div className='w-[1vw]'></div>
            ...
            <div className="flex w-full h-[14vh] justify-center items-center">
              ...
              className="w-[24vw] h-[6vh] rounded-md bg-f5green-300 text-white font-bold">회원가입</button>
            </div>
          </div>
        </div>
      </div>
