...
public class UserController {
    ...
    public ApiResult<?> getUserRecommendRecruits(@AuthID Integer authId) {
        List<UserRecommendDto> userRecommendRecruitList =
            userRecommendService.getUserRecommendRecruitList(authId);
